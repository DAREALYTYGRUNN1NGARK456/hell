...
/* —— | ———————————————————————————————————————————————————————————————————————
    ...
    I host Thorn doesn't have a default font, for the nicknames with special characters,
...
class Rank extends Command {
	...
	async run( message, [ target ] ) {
        ...
        grd.addColorStop( 0, "#e42121" );
        grd.addColorStop( 1, "#f55050" );
        ctx.lineWidth = 4;
        ctx.fillStyle = grd;
        ctx.strokeStyle = grd;
